	...
	case VM_MSG_PAINT:
	        ...
	        screenbuf = vm_graphic_get_layer_buffer(layer_hdl[0]);
                ...
                if (trigeris == VM_FALSE) {
                   ...
                   display_text_line(screenbuf, "Please load ini file.", 0, filledDsplByLines, nscreen_width, nscreen_height, 2, 1, VM_COLOR_BLACK, VM_FALSE);
                }
		break;
    ...
    if (event == VM_KEY_EVENT_UP && keycode == VM_KEY_NUM1) {
        ...
        if (trigeris == VM_FALSE) {
           if(filledDsplByLines != 0) {
             display_text_line(screenbuf, "", 0, filledDsplByLines, nscreen_width, nscreen_height, 2, 1, VM_COLOR_BLACK, VM_FALSE);
           }
           show_value("hello", "aaa");
        } else {
           display_text_line(screenbuf, "Not loaded ini file !", 0, filledDsplByLines, nscreen_width, nscreen_height, 2, 1, VM_COLOR_BLACK, VM_FALSE);
        }
...
static void show_all(void) {
	...
	for (i = 0; i < entry_count; i++) {
            ...
            display_text_line(screenbuf, a, 0, filledDsplByLines, nscreen_width, nscreen_height, 2, 1, VM_COLOR_BLACK, VM_FALSE);
	}
}
...
static void show_value(const char *section, const char *name) {
        ...
        display_text_line(screenbuf, c, 0, filledDsplByLines, nscreen_width, nscreen_height, 2, 1, VM_COLOR_BLACK, VM_FALSE);
        ...
        if (v) {
           ...
           display_text_line(screenbuf, b, 0, filledDsplByLines, nscreen_width, nscreen_height, 2, 1, VM_COLOR_BLACK, VM_FALSE);

        } else {

           display_text_line(screenbuf, "Paramether not found !", 0, filledDsplByLines, nscreen_width, nscreen_height, 2, 1, VM_COLOR_BLACK, VM_FALSE);   
        }
